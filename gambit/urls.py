...
urlpatterns = [
    ...
    url(r"^password_change/$", auth_views.password_change, {"template_name": "gambit/password_change.html", 'password_change_form': ChangeUserPasswordForm, 'post_change_redirect': 'password_change_completed'},
